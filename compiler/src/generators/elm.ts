...
function emitComponentModule(
  ...
  L.push(`module ${comp.module} exposing (Model, Msg(..), init, update, check, actionRoute, actionBody, stateDecoder)`);
  L.push(``);
  L.push(`import Dict exposing (Dict)`);
  L.push(`import Json.Decode as D`);
  L.push(`import Json.Encode as JE`);
...
function emitCompositeMain(
  ...
  for (const c of components) {
    ...
    L.push(`                    ${c.module}.update msg page.model.${cl}`);
    L.push(``);
    L.push(`                oldModel =`);
    L.push(`                    page.model`);
    L.push(`            in`);
    ...
    L.push(`                    ( { page | model = { oldModel | ${cl} = newSub }, error = Just guardMsg }, Cmd.none )`);
    L.push(``);
    L.push(`                Ok _ ->`);
    L.push(`                    ( { page | model = { oldModel | ${cl} = newSub } }`);
    L.push(`                    , postAction (${c.module}.actionRoute msg) (${c.module}.actionBody msg)`);
    L.push(`                    )`);
    L.push(``);
  }
  L.push(``);
  ...
  for (const c of components) {
    ...
    L.push(`    case ${c.module}.check msg page.model.${compLower(c)} of`);
    L.push(`        Ok _ ->`);
