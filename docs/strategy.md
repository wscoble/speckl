...
![Phase A → B → C → D flow](diagrams/plan-flow.svg)
...
**Speckl operates as a brand/property within Speckl Holdings, LLC.** Not a separate entity.

- SpeckDL is open-source (MIT/Apache 2.0)
- Dark Provenance methodology is published freely
- Trademark "Speckl" and certification authority held by Speckl Holdings
- Commercial products are Speckl Holdings revenue lines under the Speckl brand
